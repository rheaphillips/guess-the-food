...
let classes = ['confetti-container', 'overlay', 'win-modal', 'lose-modal', 'keyboard', 'play-again', 'play-again-lose'], elems = {};
...
const clearKeyboard = function () {
  alphabet.forEach((letter) => ['correct', 'present', 'absent'].forEach((cls) => accessKey(letter).classList.remove(cls)));
}
