...
let classes = ['grid', 'confetti-container', 'overlay', 'win-modal', 'lose-modal', 'keyboard', 'play-again', 'play-again-lose', 'help-modal', 'close-modal'], elems = {}, states = ['correct', 'present', 'absent'];
